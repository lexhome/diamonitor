...
#define FIRMWARE_VERSION "0.3.0.4"  // Current version of Svetlyachok, displayed at startup
...
//  tft.setRotation(2); /// ILI9341
  tft.setRotation(0); // ILI9341 240 х 320  // Установите поворот экрана перед калибровкой
...
//    analogWrite(TFT_BL, slider_day);
  ...
  else
  {
    ...
    Serial.print(timeClient.getHours());
    Serial.println(" ч.");
    analogWrite(TFT_BL, slider_night);
  }
